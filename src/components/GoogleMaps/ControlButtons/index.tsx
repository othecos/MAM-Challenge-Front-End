                ...
                <Form>
                    <Box bgcolor={'white'} className={styles.container} maxWidth={'100%'} padding={'1rem'}>
                        <Grid container direction="row" spacing={2} alignItems={'stretch'} >
                            ...
                            <Grid item > <FormikSelect placeholder={'Select POI type'} options={POI_OPTIONS} name={'poi_type'} styles={styles} /></Grid>
                            <Grid item >   <FormikSelect  placeholder={'Select radius'} options={RADIUS_OPTIONS} name={'radius'} styles={styles} /> </Grid>
                            <Grid item > <Button style={{height: '100%'}} color='primary' variant="contained" type='submit'>Apply </Button> </Grid>
